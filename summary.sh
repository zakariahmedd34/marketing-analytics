...
HOST_RESULTS_DIR="$SCRIPT_DIR/results"
...
docker cp "$CONTAINER_NAME:/app/pipeline/data/data_preprocessed.csv" "$HOST_RESULTS_DIR/" || exit 1
...
echo "All results copied to $HOST_RESULTS_DIR and container removed."